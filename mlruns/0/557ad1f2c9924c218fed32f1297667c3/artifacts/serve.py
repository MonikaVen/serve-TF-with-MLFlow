...
def main():
    with mlflow.start_run(experiment_id=0, run_name='test_clothes'):
        ...
        mlflow.tensorflow.log_model(tf_saved_model_dir = model_path, tf_meta_graph_tags = ['serve'], tf_signature_def_key = 'serving_default', artifact_path='model',registered_model_name=MODEL_NAME, input_example=INPUT_EXAMPLE, signature=signature)
